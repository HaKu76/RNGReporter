...
namespace RNGReporter.Controls
{
    ...
    public partial class CheckBoxComboBox : PopupComboBox
    {
        ...
        /// <summary>
        ///     The string that is displayed when no items are selected.
        /// </summary>
        [DefaultValue("")]
        ...
        public string DisplayMemberSingleItem
        {
            get
            {
                if (string.IsNullOrEmpty(_DisplayMemberSingleItem)) return DisplayMember;
                else return _DisplayMemberSingleItem;
            }
        ...
        ///     RNGReporter.GlassComboBox.
        /// </summary>
        /// <returns>
        ///     A RNGReporter.GlassComboBox.ObjectCollection representing the items in
        ///     the RNGReporter.GlassComboBox.
        /// </returns>
        [Browsable(true)]
        ...
        public void SynchroniseControlsWithComboBoxItems()
        {
            ...
            for (int Index0 = 0; Index0 <= _CheckBoxComboBox.Items.Count - 1; Index0++)
            {
                ...
                if (Item == null)
                {
                    ...
                    Item.Font = _CheckBoxComboBox.Font;
