...
{
    public partial class GlassComboBox : ComboBox
    {
        #region " Constructors "
        ...
        public new virtual Color BackColor
        {
            ...
            set
            {
                ...
                {
                    _backColor = value;
                    //_backColor = SystemColors.ScrollBar;
                    CreateFrames();
        ...
        /// </summary>
        /// <value>
        ///     <c>true</c> if fading with changing the focus; otherwise, <c>false</c>.
        /// </value>
        [DefaultValue(false), Category("Appearance"),
         Description(
             "Indicates whether the button should fade in and fade out when it is getting and loosing the focus.")]
        ...
        /// <summary>
        ///     Raises the <see cref="M:RNGReporter.GlassButtonBase.OnKeyUp(System.Windows.Forms.KeyEventArgs)" /> event.
        /// </summary>
        /// <param name="e">
        ...
        private ComboBox _imageButton;

        /// <summary>
        ///     Raises the <see cref="M:RNGReporter.GlassButtonBase.OnPaint(System.Windows.Forms.PaintEventArgs)" /> event.
        /// </summary>
        /// <param name="e">
                                            ...
                                            bool animating, bool enabled, float glowOpacity)
        {
            ...
            using (Graphics g = Graphics.FromImage(img))
            {
                ...
                DrawButtonBackground(g, rect, buttonRect, pressed, hovered, animating, enabled,
        ...
        private static void DrawButtonBackground(Graphics g, Rectangle rectangle, Rectangle buttonRect,
                                                 bool pressed, bool hovered, bool animating, bool enabled,
                                                 Color outerBorderColor, Color backColor, Color glowColor,
                                                 Color shineColor,
                                                 Color innerBorderColor, float glowOpacity)
        {
            ...
            buttonRect.Width -= 2;
            buttonRect.Height -= 2;
            Rectangle buttonRect2 = buttonRect;
            buttonRect2.Height >>= 1;

            #region " content "

            using (GraphicsPath bb = CreateRoundRectangle(buttonRect, 2))
            {
            ...
            {
                using (GraphicsPath clip = CreateRoundRectangle(buttonRect, 2))
                {
                    g.SetClip(clip, CombineMode.Intersect);
                    using (GraphicsPath brad = CreateBottomRadialPath(buttonRect))
                    {
            ...
            if (buttonRect2.Width > 0 && buttonRect2.Height > 0)
            {
                buttonRect2.Height++;
                using (GraphicsPath bh = CreateTopRoundRectangle(buttonRect2, 2))
                {
                    buttonRect2.Height++;
                    int opacity = 0x99;
                    if (pressed | !enabled)
